...
class JournalManager {
    ...
    checkAndAddTodayHeader() {
        ...
        // Data TEC allineata a destra (circa 80 caratteri di larghezza)
        const lineWidth = 80;
        const dateLength = tecDate.formatted.length;
        const spacesNeeded = lineWidth - dateLength;
        const spaces = ' '.repeat(Math.max(0, spacesNeeded));
        const todayHeader = `\n\n${spaces}${tecDate.formatted}\n`;
