...
function calcolaDedicaSettennio() {
    ...
    const ARS_TEMI = ['della Luna', 'dell\'Atomo', 'dell\'Acqua', 'del Vento', 'del Fuoco', 'della Terra', 'del Sole'];
    ...
    const risultato = `${numeroSettennio}° Settennio, ${temaSettennio}, della Nuova Era Terrestre`;

    // Stampa il risultato direttamente nella pagina
    document.write(`<span style="font-weight: bold; color: black;"></span> ${risultato}`);
}
