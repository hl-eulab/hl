...
// Soul Powers - sp_random.js - Elenco delle qualità dell'animo umano
...
if (dayOfWeek >= 1 && dayOfWeek <= 5) {
    ...
    document.write("<br><a href='http://earthcal.hyperlinker.org' style='text-decoration: none' target='IlCalendariodellaTerra' title='Il Calendario della Terra'><i>Potere dell'animo del giorno: " + pod[indice] + "</i></a>");
}
